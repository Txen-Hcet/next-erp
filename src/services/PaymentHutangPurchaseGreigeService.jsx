...
class PaymentHutangPurchaseGreigeService {
  async getAll() {
  ...
  async getById(id) {
    const res = await PembayaranHutangPurchaseGreige.getById(id);
    return res.data || [];
  }
...
export default new PaymentHutangPurchaseGreigeService();