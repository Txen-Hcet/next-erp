...
class PaymentHutangPurchaseJualBeliService {
  async getAll() {
  ...
  async getById(id) {
    const res = await PembayaranHutangPurchaseJualBeli.getById(id);
    return res.data || [];
  }
...
export default new PaymentHutangPurchaseJualBeliService();