...
import InventoryAksesorisPrint from "../../pages/print_function/inventory/InventoryAksesorisPrint";

export default function InventoryAksesorisDummyPrint() {
  ...
  return (
    <div class="p-6 print:p-0">
      <InventoryAksesorisPrint data={data()} /> {/* CHANGED: kirim signal value */}
    </div>
  );
}
