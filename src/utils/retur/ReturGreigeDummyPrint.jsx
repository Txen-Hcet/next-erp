...
import ReturGreigePrint from "../../pages/print_function/retur/ReturGreigePrint";

export default function ReturGreigeDummyPrint() {
  ...
  return (
    <div class="p-6 print:p-0">
      <ReturGreigePrint data={data()} /> {/* CHANGED: kirim signal value */}
    </div>
  );
}