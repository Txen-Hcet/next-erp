...
import ReturOrderCelupPrint from "../../pages/print_function/retur/ReturOrderCelupPrint";

export default function ReturOrderCelupDummyPrint() {
  ...
  return (
    <div class="p-6 print:p-0">
      <ReturOrderCelupPrint data={data()} /> {/* CHANGED: kirim signal value */}
    </div>
  );
}