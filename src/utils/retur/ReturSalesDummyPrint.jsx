...
import ReturSalesPrint from "../../pages/print_function/retur/ReturSalesPrint";

export default function ReturSalesDummyPrint() {
  ...
  return (
    <div class="p-6 print:p-0">
      <ReturSalesPrint data={data()} /> {/* CHANGED: kirim signal value */}
    </div>
  );
}