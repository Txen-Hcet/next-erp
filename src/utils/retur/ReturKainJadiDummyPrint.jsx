...
import ReturKainJadiPrint from "../../pages/print_function/retur/ReturKainJadiPrint";

export default function ReturKainJadiDummyPrint() {
  ...
  return (
    <div class="p-6 print:p-0">
      <ReturKainJadiPrint data={data()} /> {/* CHANGED: kirim signal value */}
    </div>
  );
}