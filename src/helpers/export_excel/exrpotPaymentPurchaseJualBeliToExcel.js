...
export async function exportPaymenntHutangPurchaseJualBeliToExcel({ startDate = "", endDate = "" }) {
  try {
    ...
    const dataWithDetails = await PaymentHutangPurchaseJualBeliService.getAllWithDetails(startDate, endDate);
