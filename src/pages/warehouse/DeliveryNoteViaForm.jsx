...
import SalesOrderViaDropdownSearch from "../../components/SalesOrderViaDropdownSearch";
import PackingListViaDropdownSearch from "../../components/PackingListViaDropdownSearch";
import IndeterminateCheckbox from "../../components/Indeterminate";
import { Printer, Trash2 } from "lucide-solid";

import { set, get } from "idb-keyval";

export default function DeliveryNoteViaForm() {
  ...
  return (
    <MainLayout>
      <h1 class="text-2xl font-bold mb-4">
        {isView ? "Detail" : isEdit ? "Edit" : "Tambah"} Surat Jalan Packing List (VIA)
      </h1>
