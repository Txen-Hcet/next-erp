import { PaymentHutangAksesorisEkspedisiProcessor } from '../../../helpers/process/PaymentHutangAksesorisEkspedisiProcessor';
  ...
  data.forEach((item, index) => {
    ...
    tbody += `
      <tr>
        ...
        <td>${PaymentHutangAksesorisEkspedisiProcessor.formatTanggalIndo(item.tanggal_jatuh_tempo)}</td>
        <td>${item.no_giro || '-'}</td>
        <td>${PaymentHutangAksesorisEkspedisiProcessor.formatTanggalIndo(item.tanggal_pengambilan_giro)}</td>
        <td class="text-right">${PaymentHutangAksesorisEkspedisiProcessor.fmtRp(pembayaranNum)}</td>
        <td>${item.jenis_potongan_name || '-'}</td>
        <td class="text-right">${PaymentHutangAksesorisEkspedisiProcessor.fmtRp(potonganNum)}</td>
